...
import mymoney.flex.CommitmentEntry;
import mymoney.flex.OperationEntry;
...
public class WebServicesFacade {
	 ...
	 *             Se o usuario nao tiver sido cadastrado no sistema.
	 */
	public String removeUser(String login) throws UserUnregisteredException,
	 ...
	 *             Se o e-mail for invalido.
	 */
	public String updateUser(String login, String name, String gender,
	 ...
	 */
	public String removeOperation(String login, long idOperation)
	 ...
	 */
	public String removeAccount(String login, long id)
			throws PermissionDeniedException, AccountNotFoundException {
	 ...
	 *             Caso haja algum evento inesperado com o compromisso
	 */
	public String removeCommitment(String login, long id)
			throws CommitmentException {
	 ...
	 *             sistema.
	 */
	public String exportBankOperationsCSV(String login, long accId,
	 ...
	 *             sistema.
	 */
	public String exportBankOperationsTXT(String login, long accId,
			String pathToFile) throws IOException, PermissionDeniedException,
			AccountNotFoundException {
